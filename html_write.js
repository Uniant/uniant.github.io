...
header_write.innerHTML = header_write_html.replace(/https:\/\/blog.uniant.net/g,domain + "/error/404.html/g")
header_write.innerHTML = header_write_html.replace(/https:\/\/support.uniant.net/g,domain + "/error/404.html/g")
